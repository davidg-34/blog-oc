...
class Post extends Database {
    ...
    public static function getPosts() {
        $results = self::$db->query("select posts.*, users.firstname, users.lastname, users.email FROM posts LEFT JOIN users ON posts.id_user = users.id WHERE posts.id_parent is null ORDER BY posts.created DESC LIMIT 100");
